...
|---|---|---|
| WORKFLOW | `WORKFLOW_<MOD_ID>_<MC-VERSION>.md` | `WORKFLOW_BETTER_CONNECTIONS_26-1-2.md` |
...
git checkout minecraft/26.1.2/neoforge-26.1.2.84/production
git checkout -b minecraft/26.1.2/neoforge-26.1.2.84/main
git push origin minecraft/26.1.2/neoforge-26.1.2.84/main
git checkout minecraft/26.1.2/neoforge-26.1.2.84/production
```
...
2. Añadir `https://<token>@github.com/tuusuario/better-connections.git`
3. Dirección: **Push**
...
| Ejemplo | Significado |
|---|---|
| `better_connections-26.1.2-neoforge-0.0.0-beta.1.jar` | NeoForge 26.1.2, beta 1 |
| `better_connections-26.1.2-neoforge-1.0.0.jar` | NeoForge 26.1.2, release 1.0.0 |
...
```bash
# Beta
git tag -a 26.1.2-neoforge-beta.1 -m "v0.0.0-beta.1: Initial port from BetterWalls"
...
#    cp build/libs/better_connections-26.1.2-neoforge-0.0.0-beta.1.jar /ruta/a/la/instancia/mods/
#    rm /ruta/a/la/instancia/mods/better_connections-26.1.2-neoforge-version-anterior.jar
```
