...
> Este archivo pertenece al proyecto **Better Connections**. Cambios aquí solo afectan a este proyecto.
...
| Rama | `minecraft/26.1.2/neoforge-26.1.2.84/production` |

## Convenciones de nomenclatura

| Convención | Uso | Ejemplo |
|---|---|---|
| **snake_case** | `mod_id`, assets/, packages Java | `better_connections` |
| **PascalCase** | Clases Java principales | `BetterConnections` |
| **camelCase** | Variables, métodos, config keys | `better_connectionsConfig` |
| **Title Case** | Display name (README, CHANGELOG, docs, CurseForge) | `Better Connections` |
